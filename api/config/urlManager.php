...
return [
    ...
    'rules' => [
        [
            'class' => UrlRule::class,
            'controller' => ['user', 'teacher', 'student'],
            'pluralize' => false,
            'extraPatterns' => [
                'POST signup' => 'signup',
                'POST login' => 'login',
                ...
                ////////////////////////////////// 
                ///////////////////////////////////////////////////'student-courses'
                'GET studentcourses' => 'student-courses',
                'POST  registercourse' =>  'register-course',
                'GET view/<id:\d+>' => 'view',
                'PUT updatestudentcourse/<student_id:\d+>' => 'update-student-course',
                 'GET grades/<id:\d+>' => 'grades',
