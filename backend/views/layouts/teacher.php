...
<body>
    ...
    <div class="sidebar">
        <div class="brand">
            <i class="fas fa-user-shield"></i> Teacher Panel
        </div>

        <a href="<?= \yii\helpers\Url::to(['teacher/profile']) ?>">
            <i class="fas fa-user-graduate"></i> Profile</a>

        <a href="<?= \yii\helpers\Url::to(['teacher/index']) ?>">
            <i class="fas fa-user-graduate"></i> Students</a>
        <a href="<?= \yii\helpers\Url::to(['document/index']) ?>"><i class="fas fa-book-open"></i> Documents</a>
        <a href="<?= \yii\helpers\Url::to(['document/assignment']) ?>">
